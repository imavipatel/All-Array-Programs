...
public class SubtractTwoMatrixInArray{
  public static void main(String[] args) {
    int x[][] = readMatrix();
    int y[][] = readMatrix();
    int z[][] = subtractTwoMatrixInArray(x,y);
    displayMatrix(z);
  }
  ...
  public static int [][] subtractTwoMatrixInArray(int x[][], int y[][])
  {
    if(x.length!=y.length||x[0].length!=y[0].length)
    {
      System.out.println("Subtraction is not possible!, Rows and columns must be same.");
      return null;
    }
